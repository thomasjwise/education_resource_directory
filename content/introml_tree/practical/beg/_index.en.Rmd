...
Apply the following code to your data to convert from numeric to binary data.
...
class_pred <- predict(object = , ## Specify the model here
                      newdata = ) ## Specify the new data here

## For classification trees 
reg_pred <- predict(object = , ## Specify the model here
                      newdata = ) ## Specify the new data here
...
confusionMatrix(data = , ## Specify the predicted data and specifically the output
                reference = ) ## Specify the reference data and specifically the output
