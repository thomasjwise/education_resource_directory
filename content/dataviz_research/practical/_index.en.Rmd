...
* Participant Number (*S. No.*)
* Timestamp (*Timestamp*)
* Gender (*Gender*)
* Age (*Age*)
* Employment Status (*Work*)
* Degree / Education Level (*Degree*)
* Birthplace (*Birthplace*, *Birthplace_ISO3*)
* Country of Residence (*Residence*, *Residence_ISO3*)
* GAD Individual Scores (*GAD1* - *GADE*, *GAD_T*)
* SWL Individual Scores (*SWL1* - *SWL5*, *SWL_T*)
* SPIN Individual Scores (*SPIN1* - *SPIN17*, *SPIN_T*)
* Narcissism Score (*Narcissism*)
* Specific Game (*Game*)
* Gaming Platform (*Platform*)
* Hours Played per week (*Hours*)
* Earnings through gaming (*earnings*)
* Reason for playing (*whyplay*)
* Gaming League (*League*)
* Highest League played (*highestleague*)
* Streams (*streams*)
* Playstyle (*Playstyle*)
* Accepted? (*accept*)
* Reference Collection Point (*Reference*)
...
**Hint:** Ensure to add *stat = "summary", fun.y = "mean"* into your *geom_bar()* function.
